## [2.0.0](https://github.com/Structed/addon-template-test/compare/1.0.0...2.0.0) (2023-01-25)
...
* set ADDON_NAME to godot-playfab ([5c2de9a](https://github.com/Structed/addon-template-test/commit/5c2de9aeb8d4c5700a17df85c4eac5cb12b46fee))
* use ADDON_NAME env var * fix ASSET_LIB_PASSWORD ([83d0c8a](https://github.com/Structed/addon-template-test/commit/83d0c8a81ce7dac570f127e1ccd40504509d1a52))


### Continuous Integration

* try env in path for main.yml ([83625fe](https://github.com/Structed/addon-template-test/commit/83625feb44d3142a47d364913347db37048deeba))
* Use godot-playfab for godot 3.5 for tests (instead of 4) ([578a919](https://github.com/Structed/addon-template-test/commit/578a9193600f12658ce58b43e501e4f9f50355ca))
...
* update EndBug/add-and-commit@v9.1.1 ([e0ab5b3](https://github.com/Structed/addon-template-test/commit/e0ab5b372c5bed13c5a5a065c4996c169328b5f1))
...
## [2.0.0](https://github.com/Structed/addon-template-test/compare/1.0.0...2.0.0) (2023-01-22)
